...
//ICU 996 token contract
contract ICU is ERC20, Owned {
    ...
    constructor() ERC20("996 ICU", "996") {
        minSupply = 65536 * (10 ** 18); //min supply 2^16
        uint256 totalSupply = 4294967296 * (10 ** 18); //total supply 2^32
        feesEnabled = false;
    ...
    function _transfer(
        ...
        uint256 burnedFee = calculateFee(amount, 5);
        ...
        ERC20._transfer(sender, recipient, amount.sub(burnedFee));
    }
